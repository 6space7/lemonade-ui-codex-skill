...
Use this as the short taste index. For detailed work, load the focused reference named by `SKILL.md`.
...
- Composition discipline before poster/collage/glow effects.
...
- Responsive story before breakpoint patching.
- One memorable visual idea, not a pile of effects.
...
- Gets loud, tilted, cramped, or fake: `composition-discipline.md`.
...
- Fake or vague product: `product-evidence.md`.
- AI-ish template feel: `anti-ai-slop.md`.
- Motion details: `motion-recipes.md`.
- Final pass: `review-checklist.md`.
